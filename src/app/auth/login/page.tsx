...
function LoginForm() {
  ...
  useEffect(() => {
    if (searchParams) {
      ...
      } else if (oauthError === "AuthenticationFailed") {
        setError("Google authentication was successful but could not retrieve user profile.");
      }
    }
  }, [searchParams]);
        ...
        >
          ...
          <div className="mt-8 grid grid-cols-2 gap-4">
            <button 
              ...
              disabled={loading || googleLoading}
              className="flex items-center justify-center gap-2 bg-white border border-gray-200 py-3 rounded-xl font-medium text-gray-700 hover:bg-gray-50 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
            >
              {googleLoading ? (
